...
Suppose our goal is to predict whether or not an apartment is in SF. To do this, we use `in_sf` which is a **binary** response variable, and elevation as our explanatory variable. What we want is a *monotonic* function which outputs something like 1 or54 0 for a given `elevation`.
